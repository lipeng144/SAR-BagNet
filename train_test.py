...
if __name__ == '__main__':
    ...
    img_size=100
    train_dir = 'D:/lipeng/SARProtoPNet/img/train'
    test_dir = 'D:/lipeng/SARProtoPNet/img/test'
    ...
    lr = 0.001
    mode_dir = 'D:/lipeng/bag-of-local-features-models-master/bag-of-local-features-models-master/saved_model_1/'
    num_epochs=300
    net = SAR_BagNet.BagNet18(pretrained=False)
    optimizer = torch.optim.Adam(net.parameters(), lr=lr)
    train(train_loader,test_loader,net,optimizer,device,num_epochs)
    torch.save(obj=net, f=os.path.join(mode_dir, ('SARBagnet' + '{0:.3f}.pth').format(17)))